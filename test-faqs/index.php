...
<head>
	...
	<title>Test FAQs | Study Smart</title>
...
<body>
	...
	<div class="container mt-3">
		<div class="row">
			<div class="col-md-12">
				<h2 class="text-center pb-2 page-heading-text">IELTS Test FAQs</h2>
				<p class="page-para-text text-justify pt-1 pb-1">The first things you hear when you researching about going abroad to study are some words like GMAT, GRE, TOEFL and IELTS. What exactly are these? Well, to begin with, every student aspiring to join an educational institution in a foreign country is required to appear for an entrance exam similar to ones we have in India, viz-a-viz the IITJEE, AIEEE, etc. There are the usual aptitude tests such as SAT, GMAT & GRE and there are language proficiency exams such as IELTS (International English Language Testing System) and TOEFL (Test of English as a Foreign Language) for students from countries which do not have English as their native language.</p>
				<p class="page-para-text text-justify pt-1 pb-1">The IELTS test is standard for admission to most of the top universities around the globe, in addition, it is also required by professionals planning to work or migrate abroad. The test is divided into four modules, namely, Listening, Reading, Writing and Speaking. An average test taker usually takes up to 2 hours and 45 minutes to finish the test. The scoring scale on the IELTS is from 0-9, with different institutions having their own cut-offs. The IELTS tests are held at over 800 centres with tests up-to four times a month. The IELTS is available in two test formats, the IELTS Academic or the IELTS General Training. The Academic module is for candidates who wish to study at undergraduate or postgraduate levels, whereas the General training module is for candidates wishing to migrate to an English speaking country. All candidates take the same Listening and Speaking components, but different Reading and Writing Components.</p>
				<p class="page-para-text text-justify pt-1 pb-1">Lets’ have a brief look at what you will face when you write the IELTS Exam:</p>
				<p class="page-para-text text-justify pt-1 pb-1">
					<strong>IELTS General and Academic Practices in Listening</strong> <br>In the listening module, you are made to attempt four parts with a total of 40 questions, which assess your understanding of main ideas and specific information, recognizing opinions, etc. Each correct answer receives 1 mark and the total score converted to standard IELTS 9-band scale.
				</p>
				<p class="page-para-text text-justify pt-1 pb-1">
					<strong>IELTS General and Academic Practices in Reading</strong> <br>The reading module, with a total of 40 questions divided into three sections. As the name suggests, the module tests your reading and interference skills. Similar to the listening module, each correct answer receives 1 mark, with the total converted to the 9-band scale.
				</p>
				<p class="page-para-text text-justify pt-1 pb-1">
					<strong>IELTS General and Academic Practices in Writing</strong> <br>The Writing module has two parts, including essay writing. Candidates are assessed on the performance in both tasks and scored according to task achievement, coherence and cohesion, lexical resource, grammatical range and accuracy.
				</p>
				<p class="page-para-text text-justify pt-1 pb-1">
					<strong>IELTS General and Academic Practices in Speaking</strong> <br>The last module, lasting 11-14 minutes, is a face-to-face verbal interview with an examiner. The candidate is passed through three stages, introduction and interview, individual long turn and a two-way discussion with the examiner.
				</p>
				<p class="page-para-text text-justify pt-1 pb-1">
